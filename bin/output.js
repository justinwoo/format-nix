...
(function(exports) {
  ...
  var layout = function (v) {
      ...
      throw new Error("Failed pattern match at FormatNix (line 234, column 1 - line 234, column 26): " + [ v.constructor.name ]);
  };
  var fits = function ($copy_w) {
      return function ($copy_v) {
          ...
          function $tco_loop(w, v) {
              ...
              throw new Error("Failed pattern match at FormatNix (line 259, column 1 - line 259, column 32): " + [ w.constructor.name, v.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var expr2Doc = function (v) {
      ...
      var v1 = function (v2) {
          if (v instanceof AttrSet) {
              var $256 = Data_Array["null"](v.value0);
              if ($256) {
                  return new DText("{}");
              };
              var left = new DText("{");
          ...
          throw new Error("Failed pattern match at FormatNix (line 278, column 1 - line 278, column 24): " + [ v.constructor.name ]);
      };
              ...
              var v3 = function (v4) {
                  ...
                  var v5 = function (v6) {
                      ...
                      var v7 = function (v8) {
                          ...
                          var v9 = function (v10) {
                              ...
                              if (v === "quantity") {
                                  ...
                                  if ($356 instanceof Data_List_Types.Cons && $356.value1 instanceof Data_List_Types.Nil) {
                                      return new Quantity($356.value0);
                                  };
                                  return v11(true);
                              };
                              return v11(true);
                          ...
                          if (v === "let") {
                              var $361 = Data_List.fromFoldable(Data_Foldable.foldableArray)(namedChildren(n));
                              if ($361 instanceof Data_List_Types.Cons && ($361.value1 instanceof Data_List_Types.Cons && $361.value1.value1 instanceof Data_List_Types.Nil)) {
                                  return new Let(readNode($361.value0), readNode($361.value1.value0));
                              };
                              return v9(true);
                          };
                          return v9(true);
  ...
  var be = function (w) {
      return function (k) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at FormatNix (line 247, column 1 - line 247, column 50): " + [ w.constructor.name, k.constructor.name, v.constructor.name ]);
          };
      };
  };
  var best = function (w) {
