...
(function($PS) {
  ...
  var layout = function (v) {
      ...
      throw new Error("Failed pattern match at FormatNix (line 241, column 1 - line 241, column 26): " + [ v.constructor.name ]);
  };
  var fits = function ($copy_w) {
      return function ($copy_v) {
          ...
          function $tco_loop(w, v) {
              ...
              throw new Error("Failed pattern match at FormatNix (line 266, column 1 - line 266, column 32): " + [ w.constructor.name, v.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var expr2Doc = function (v) {
      ...
      var v1 = function (v2) {
          if (v instanceof AttrSet) {
              var $254 = Data_Array["null"](v.value0);
              if ($254) {
                  return new DText("{}");
              };
              var left = new DText("{");
              ...
              var expr$prime = (function () {
                  var v3 = function (v4) {
                      if (Data_Boolean.otherwise) {
                          return DNest.create(1)(dlines2(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(expr2Doc)(v.value1)));
                      };
                      throw new Error("Failed pattern match at FormatNix (line 285, column 1 - line 285, column 24): " + [  ]);
                  };
                  var $261 = Data_Array.length(v.value1) === 1;
                  if ($261) {
                      var $262 = Data_Array.head(v.value1);
                      if ($262 instanceof Data_Maybe.Just) {
                          return expr2Doc($262.value0);
                      };
                      return v3(true);
                  };
                  return v3(true);
              })();
              var binds$prime = DNest.create(1)(dlines2(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(expr2Doc)(v.value0)));
          ...
          throw new Error("Failed pattern match at FormatNix (line 285, column 1 - line 285, column 24): " + [ v.constructor.name ]);
      };
      if (v instanceof Attrs) {
          var $287 = Data_Functor.map(Data_Functor.functorArray)(expr2Doc)(v.value0);
          return new DAlt(Data_Foldable.intercalate(Data_Foldable.foldableArray)(mDoc)(new DText(" "))($287), new DNest(1, dlines(Data_Foldable.foldableArray)($287)));
      };
      return v1(true);
  };
  ...
  var namedChildren = function ($436) {
      return Data_Array.filter(isNamed)(children($436));
  };
      ...
      return function (n) {
          ...
          var v1 = function (v2) {
              ...
              var v3 = function (v4) {
                  ...
                  var v5 = function (v6) {
                      ...
                      var v7 = function (v8) {
                          ...
                          var v9 = function (v10) {
                              ...
                              var v11 = function (v12) {
                                  if (v === "parenthesized" && Data_Boolean.otherwise) {
                                      return new Unknown("parenthesized variation", text(n));
                                  };
                                  var v13 = function (v14) {
                                      ...
                                      var v15 = function (v16) {
                                          ...
                                          var v17 = function (v18) {
                                              ...
                                              var v19 = function (v20) {
                                                  ...
                                                  if (v === "binary") {
                                                      ...
                                                      if ($316 instanceof Data_List_Types.Cons && ($316.value1 instanceof Data_List_Types.Cons && ($316.value1.value1 instanceof Data_List_Types.Cons && $316.value1.value1.value1 instanceof Data_List_Types.Nil))) {
                                                          return new Binary(readNode($316.value0), text($316.value1.value0), readNode($316.value1.value1.value0));
                                                      };
                                                      return v21(true);
                                                  };
                                                  return v21(true);
                                              ...
                                              if (v === "unary") {
                                                  var $325 = children(n);
                                                  var $326 = Data_List.fromFoldable(Data_Foldable.foldableArray)($325);
                                                  if ($326 instanceof Data_List_Types.Cons && ($326.value1 instanceof Data_List_Types.Cons && $326.value1.value1 instanceof Data_List_Types.Nil)) {
                                                      return new Unary(text($326.value0), readNode($326.value1.value0));
                                                  };
                                                  return v19(true);
                                              };
                                              return v19(true);
                                          ...
                                          if (v === "select") {
                                              var $333 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                                              if ($333 instanceof Data_List_Types.Cons && ($333.value1 instanceof Data_List_Types.Cons && $333.value1.value1 instanceof Data_List_Types.Nil)) {
                                                  return new Select($333.value0, $333.value1.value0);
                                              };
                                              return v17(true);
                                          };
                                          return v17(true);
                                      ...
                                      if (v === "with") {
                                          var $340 = namedChildren(n);
                                          var $341 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                                          if ($341 instanceof Data_List_Types.Cons && ($341.value1 instanceof Data_List_Types.Cons && $341.value1.value1 instanceof Data_List_Types.Nil)) {
                                              return new With($341.value0, $341.value1.value0);
                                          };
                                          return v15(true);
                                      };
                                      return v15(true);
                                  ...
                                  if (v === "bind") {
                                      var $348 = namedChildren(n);
                                      var $349 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                                      if ($349 instanceof Data_List_Types.Cons && ($349.value1 instanceof Data_List_Types.Cons && $349.value1.value1 instanceof Data_List_Types.Nil)) {
                                          return new Bind($349.value0, $349.value1.value0);
                                      };
                                      return v13(true);
                                  };
                                  return v13(true);
                              ...
                              if (v === "parenthesized") {
                                  var $356 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                                  if ($356 instanceof Data_List_Types.Cons && $356.value1 instanceof Data_List_Types.Nil) {
                                      return new Parens($356.value0);
                                  };
                                  return v11(true);
                              };
                              return v11(true);
                          ...
                          if (v === "let") {
                              var $361 = Data_Array.drop(1)(children(n));
                              var $362 = Data_Array.findIndex(function (x) {
                                  return Data_Eq.eq(eqTypeString)(type_(x))("in");
                              })($361);
                              if ($362 instanceof Data_Maybe.Just) {
                                  var $363 = Data_Functor.map(Data_Functor.functorArray)(readNode)(Data_Array.take($362.value0)($361));
                                  var $364 = Data_Functor.map(Data_Functor.functorArray)(readNode)(Data_Array.drop($362.value0 + 1 | 0)($361));
                                  return new Let($363, $364);
                              };
                              return v9(true);
                          };
                          return v9(true);
                      ...
                      if (v === "if") {
                          var $368 = Data_List.fromFoldable(Data_Foldable.foldableArray)(namedChildren(n));
                          if ($368 instanceof Data_List_Types.Cons && ($368.value1 instanceof Data_List_Types.Cons && ($368.value1.value1 instanceof Data_List_Types.Cons && $368.value1.value1.value1 instanceof Data_List_Types.Nil))) {
                              return new If(readNode($368.value0), readNode($368.value1.value0), readNode($368.value1.value1.value0));
                          };
                          return v7(true);
                      };
                      return v7(true);
                  ...
                  if (v === "app") {
                      var $377 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                      if ($377 instanceof Data_List_Types.Cons && ($377.value1 instanceof Data_List_Types.Cons && $377.value1.value1 instanceof Data_List_Types.Nil)) {
                          return new App($377.value0, $377.value1.value0);
                      };
                      return v5(true);
                  };
                  return v5(true);
              ...
              if (v === "formal") {
                  ...
                  if ($384 instanceof Data_List_Types.Cons && $384.value1 instanceof Data_List_Types.Nil) {
                      return new Formal($384.value0, Data_Maybe.Nothing.value);
                  };
                  if ($384 instanceof Data_List_Types.Cons && ($384.value1 instanceof Data_List_Types.Cons && $384.value1.value1 instanceof Data_List_Types.Nil)) {
                      return new Formal($384.value0, new Data_Maybe.Just($384.value1.value0));
                  };
          ...
          if (v === "function") {
              var $394 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
              if ($394 instanceof Data_List_Types.Cons && ($394.value1 instanceof Data_List_Types.Cons && $394.value1.value1 instanceof Data_List_Types.Nil)) {
                  if ($394.value0 instanceof Formals) {
                      return new SetFunction($394.value0, $394.value1.value0);
                  };
                  return new $$Function($394.value0, $394.value1.value0);
              };
              return v1(true);
          };
          return v1(true);
  ...
  var be = function (w) {
      return function (k) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at FormatNix (line 254, column 1 - line 254, column 50): " + [ w.constructor.name, k.constructor.name, v.constructor.name ]);
          };
      };
  };
  var best = function (w) {
  ...
  var printExpr = function ($437) {
      return pretty(80)(expr2Doc($437));
  };
