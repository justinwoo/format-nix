...
(function(exports) {
  ...
  var layout = function (v) {
      ...
      throw new Error("Failed pattern match at FormatNix (line 239, column 1 - line 239, column 26): " + [ v.constructor.name ]);
  };
  var fits = function ($copy_w) {
      return function ($copy_v) {
          ...
          function $tco_loop(w, v) {
              ...
              throw new Error("Failed pattern match at FormatNix (line 264, column 1 - line 264, column 32): " + [ w.constructor.name, v.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var dlines2 = function (dictFoldable) {
      return function (xs) {
          return Data_Semigroup.append(sgDoc)(DLine.value)(Data_Foldable.intercalate(dictFoldable)(mDoc)(Data_Semigroup.append(sgDoc)(DLine.value)(DLine.value))(xs));
      };
  };
  ...
  var expr2Doc = function (v) {
      ...
      if (v instanceof Unknown) {
          return DText.create("Unknown " + (v.value0 + (" " + v.value1)));
      };
      if (v instanceof Unary) {
          return Data_Semigroup.append(sgDoc)(new DText(v.value0))(expr2Doc(v.value1));
      };
      if (v instanceof Binary) {
          return Data_Semigroup.append(sgDoc)(expr2Doc(v.value0))(Data_Semigroup.append(sgDoc)(new DText(" " + (v.value1 + " ")))(expr2Doc(v.value2)));
      };
      ...
      var v1 = function (v2) {
          if (v instanceof AttrSet) {
              var $258 = Data_Array["null"](v.value0);
              if ($258) {
                  return new DText("{}");
              };
              var left = new DText("{");
              ...
              var expr$prime = (function () {
                  var v3 = function (v4) {
                      if (Data_Boolean.otherwise) {
                          return DNest.create(1)(dlines(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(expr2Doc)(v.value1)));
                      };
                      throw new Error("Failed pattern match at FormatNix (line 283, column 1 - line 283, column 24): " + [  ]);
                  };
                  var $265 = Data_Array.length(v.value1) === 1;
                  if ($265) {
                      var $266 = Data_Array.head(v.value1);
                      if ($266 instanceof Data_Maybe.Just) {
                          return expr2Doc($266.value0);
                      };
                      return v3(true);
                  };
                  return v3(true);
              })();
              var binds$prime = DNest.create(1)(dlines(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(expr2Doc)(v.value0)));
          ...
          if (v instanceof Binds) {
              return Data_Foldable.intercalate(Data_Foldable.foldableArray)(mDoc)(Data_Semigroup.append(sgDoc)(DLine.value)(DLine.value))(Data_Functor.map(Data_Functor.functorArray)(expr2Doc)(v.value0));
          };
          ...
          if (v instanceof Formals) {
              var exprs$prime = Data_Functor.map(Data_Functor.functorArray)(expr2Doc)(v.value0);
              var lines = Data_Semigroup.append(sgDoc)(new DNest(1, Data_Semigroup.append(sgDoc)(DLine.value)(Data_Foldable.intercalate(Data_Foldable.foldableArray)(mDoc)(Data_Semigroup.append(sgDoc)(new DText(","))(DLine.value))(exprs$prime))))(DLine.value);
              var oneLine = Data_Semigroup.append(sgDoc)(new DText(" "))(Data_Semigroup.append(sgDoc)(Data_Foldable.intercalate(Data_Foldable.foldableArray)(mDoc)(new DText(", "))(exprs$prime))(new DText(" ")));
              return new DAlt(oneLine, lines);
          };
          ...
          throw new Error("Failed pattern match at FormatNix (line 283, column 1 - line 283, column 24): " + [ v.constructor.name ]);
      };
      if (v instanceof Attrs) {
          var $292 = Data_Functor.map(Data_Functor.functorArray)(expr2Doc)(v.value0);
          return new DAlt(Data_Foldable.intercalate(Data_Foldable.foldableArray)(mDoc)(new DText(" "))($292), new DNest(1, dlines(Data_Foldable.foldableArray)($292)));
      };
      return v1(true);
  };
  ...
  var namedChildren = function ($441) {
      return Data_Array.filter(isNamed)(children($441));
  };
      ...
      return function (n) {
          ...
          var v1 = function (v2) {
              ...
              var v3 = function (v4) {
                  ...
                  var v5 = function (v6) {
                      ...
                      var v7 = function (v8) {
                          ...
                          var v9 = function (v10) {
                              ...
                              var v11 = function (v12) {
                                  ...
                                  var v13 = function (v14) {
                                      ...
                                      var v15 = function (v16) {
                                          ...
                                          var v17 = function (v18) {
                                              ...
                                              var v19 = function (v20) {
                                                  ...
                                                  if (v === "binary") {
                                                      ...
                                                      if ($321 instanceof Data_List_Types.Cons && ($321.value1 instanceof Data_List_Types.Cons && ($321.value1.value1 instanceof Data_List_Types.Cons && $321.value1.value1.value1 instanceof Data_List_Types.Nil))) {
                                                          return new Binary(readNode($321.value0), text($321.value1.value0), readNode($321.value1.value1.value0));
                                                      };
                                                      return v21(true);
                                                  };
                                                  return v21(true);
                                              ...
                                              if (v === "unary") {
                                                  var $330 = children(n);
                                                  var $331 = Data_List.fromFoldable(Data_Foldable.foldableArray)($330);
                                                  if ($331 instanceof Data_List_Types.Cons && ($331.value1 instanceof Data_List_Types.Cons && $331.value1.value1 instanceof Data_List_Types.Nil)) {
                                                      return new Unary(text($331.value0), readNode($331.value1.value0));
                                                  };
                                                  return v19(true);
                                              };
                                              return v19(true);
                                          ...
                                          if (v === "select") {
                                              var $338 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                                              if ($338 instanceof Data_List_Types.Cons && ($338.value1 instanceof Data_List_Types.Cons && $338.value1.value1 instanceof Data_List_Types.Nil)) {
                                                  return new Select($338.value0, $338.value1.value0);
                                              };
                                              return v17(true);
                                          };
                                          return v17(true);
                                      ...
                                      if (v === "with") {
                                          ...
                                          if ($346 instanceof Data_List_Types.Cons && ($346.value1 instanceof Data_List_Types.Cons && $346.value1.value1 instanceof Data_List_Types.Nil)) {
                                              return new With($346.value0, $346.value1.value0);
                                          };
                                          return v15(true);
                                      };
                                      return v15(true);
                                  ...
                                  if (v === "bind") {
                                      var $353 = namedChildren(n);
                                      var $354 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                                      if ($354 instanceof Data_List_Types.Cons && ($354.value1 instanceof Data_List_Types.Cons && $354.value1.value1 instanceof Data_List_Types.Nil)) {
                                          return new Bind($354.value0, $354.value1.value0);
                                      };
                                      return v13(true);
                                  };
                                  return v13(true);
                              ...
                              if (v === "quantity") {
                                  var $361 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                                  if ($361 instanceof Data_List_Types.Cons && $361.value1 instanceof Data_List_Types.Nil) {
                                      return new Quantity($361.value0);
                                  };
                                  return v11(true);
                              };
                              return v11(true);
                          ...
                          if (v === "let") {
                              var $366 = Data_Array.drop(1)(children(n));
                              var $367 = Data_Array.findIndex(function (x) {
                                  return Data_Eq.eq(eqTypeString)(type_(x))("in");
                              })($366);
                              if ($367 instanceof Data_Maybe.Just) {
                                  var $368 = Data_Functor.map(Data_Functor.functorArray)(readNode)(Data_Array.take($367.value0)($366));
                                  var $369 = Data_Functor.map(Data_Functor.functorArray)(readNode)(Data_Array.drop($367.value0 + 1 | 0)($366));
                                  return new Let($368, $369);
                              };
                              return v9(true);
                          };
                          return v9(true);
                      ...
                      if (v === "if") {
                          var $373 = Data_List.fromFoldable(Data_Foldable.foldableArray)(namedChildren(n));
                          if ($373 instanceof Data_List_Types.Cons && ($373.value1 instanceof Data_List_Types.Cons && ($373.value1.value1 instanceof Data_List_Types.Cons && $373.value1.value1.value1 instanceof Data_List_Types.Nil))) {
                              return new If(readNode($373.value0), readNode($373.value1.value0), readNode($373.value1.value1.value0));
                          };
                          return v7(true);
                      };
                      return v7(true);
                  ...
                  if (v === "app") {
                      var $382 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                      if ($382 instanceof Data_List_Types.Cons && ($382.value1 instanceof Data_List_Types.Cons && $382.value1.value1 instanceof Data_List_Types.Nil)) {
                          return new App($382.value0, $382.value1.value0);
                      };
                      return v5(true);
                  };
                  return v5(true);
              ...
              if (v === "formal") {
                  ...
                  if ($389 instanceof Data_List_Types.Cons && $389.value1 instanceof Data_List_Types.Nil) {
                      return new Formal($389.value0, Data_Maybe.Nothing.value);
                  };
                  if ($389 instanceof Data_List_Types.Cons && ($389.value1 instanceof Data_List_Types.Cons && $389.value1.value1 instanceof Data_List_Types.Nil)) {
                      return new Formal($389.value0, new Data_Maybe.Just($389.value1.value0));
                  };
          ...
          if (v === "function") {
              var $399 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
              if ($399 instanceof Data_List_Types.Cons && ($399.value1 instanceof Data_List_Types.Cons && $399.value1.value1 instanceof Data_List_Types.Nil)) {
                  if ($399.value0 instanceof Formals) {
                      return new SetFunction($399.value0, $399.value1.value0);
                  };
                  return new $$Function($399.value0, $399.value1.value0);
              };
              return v1(true);
          };
          return v1(true);
  ...
  var be = function (w) {
      return function (k) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at FormatNix (line 252, column 1 - line 252, column 50): " + [ w.constructor.name, k.constructor.name, v.constructor.name ]);
          };
      };
  };
  var best = function (w) {
  ...
  var printExpr = function ($442) {
      return pretty(80)(expr2Doc($442));
  };
