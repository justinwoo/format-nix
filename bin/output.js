  ...
  var expr2Doc = function (ctx) {
      return function (v) {
          ...
          if (v instanceof Unknown) {
              return Motsunabe.DText.create("Unknown " + (v.value0 + (" " + v.value1)));
          };
          ...
          var v1 = function (v2) {
              if (v instanceof AttrSet) {
                  var $238 = Data_Array["null"](v.value0);
                  if ($238) {
                      return new Motsunabe.DText("{}");
                  };
              ...
              if (v instanceof Let) {
                  ...
                  var expr$prime = (function () {
                      var v3 = function (v4) {
                          ...
                          throw new Error("Failed pattern match at FormatNix (line 221, column 1 - line 221, column 35): " + [  ]);
                      };
                      var $246 = Data_Array.length(v.value1) === 1;
                      if ($246) {
                          var $247 = Data_Array.head(v.value1);
                          if ($247 instanceof Data_Maybe.Just) {
                              return expr2Doc(ctx)($247.value0);
                          };
                          return v3(true);
                      };
                      return v3(true);
              ...
              if (v instanceof App) {
                  var newCtx = (function () {
                      var $260 = containsFetch(v.value0);
                      if ($260) {
                          return {
                              fetch: true
                          };
              ...
              throw new Error("Failed pattern match at FormatNix (line 221, column 1 - line 221, column 35): " + [ ctx.constructor.name, v.constructor.name ]);
          };
          if (v instanceof Attrs) {
              var $274 = Data_Functor.map(Data_Functor.functorArray)(expr2Doc(ctx))(v.value0);
              return new Motsunabe.DAlt(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Motsunabe.mDoc)(new Motsunabe.DText(" "))($274), new Motsunabe.DNest(1, dlines(Data_Foldable.foldableArray)($274)));
          };
          return v1(true);
      };
  };
  var printExpr = function ($388) {
      return Motsunabe.pretty(80)(expr2Doc(defaultContext)($388));
  };
  var children = function (tn) {
      return tn.children;
  };
  var namedChildren = function ($389) {
      return Data_Array.filter(isNamed)(children($389));
  };
      ...
      return function (n) {
          ...
          var v1 = function (v2) {
              ...
              var v3 = function (v4) {
                  ...
                  var v5 = function (v6) {
                      ...
                      var v7 = function (v8) {
                          ...
                          var v9 = function (v10) {
                              ...
                              var v11 = function (v12) {
                                  ...
                                  var v13 = function (v14) {
                                      ...
                                      var v15 = function (v16) {
                                          ...
                                          var v17 = function (v18) {
                                              ...
                                              var v19 = function (v20) {
                                                  ...
                                                  if (v === "binary") {
                                                      ...
                                                      if ($303 instanceof Data_List_Types.Cons && ($303.value1 instanceof Data_List_Types.Cons && ($303.value1.value1 instanceof Data_List_Types.Cons && $303.value1.value1.value1 instanceof Data_List_Types.Nil))) {
                                                          return new Binary(readNode($303.value0), text($303.value1.value0), readNode($303.value1.value1.value0));
                                                      };
                                                      return v21(true);
                                                  };
                                                  return v21(true);
                                              ...
                                              if (v === "unary") {
                                                  var $312 = children(n);
                                                  var $313 = Data_List.fromFoldable(Data_Foldable.foldableArray)($312);
                                                  if ($313 instanceof Data_List_Types.Cons && ($313.value1 instanceof Data_List_Types.Cons && $313.value1.value1 instanceof Data_List_Types.Nil)) {
                                                      return new Unary(text($313.value0), readNode($313.value1.value0));
                                                  };
                                                  return v19(true);
                                              };
                                              return v19(true);
                                          ...
                                          if (v === "select") {
                                              var $320 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                                              if ($320 instanceof Data_List_Types.Cons && ($320.value1 instanceof Data_List_Types.Cons && $320.value1.value1 instanceof Data_List_Types.Nil)) {
                                                  return new Select($320.value0, $320.value1.value0);
                                              };
                                              return v17(true);
                                          };
                                          return v17(true);
                                      ...
                                      if (v === "with") {
                                          ...
                                          if ($328 instanceof Data_List_Types.Cons && ($328.value1 instanceof Data_List_Types.Cons && $328.value1.value1 instanceof Data_List_Types.Nil)) {
                                              return new With($328.value0, $328.value1.value0);
                                          };
                                          return v15(true);
                                      };
                                      return v15(true);
                                  ...
                                  if (v === "bind") {
                                      ...
                                      if ($336 instanceof Data_List_Types.Cons && ($336.value1 instanceof Data_List_Types.Cons && $336.value1.value1 instanceof Data_List_Types.Nil)) {
                                          return new Bind($336.value0, $336.value1.value0);
                                      };
                                      return v13(true);
                                  };
                                  return v13(true);
                              ...
                              if (v === "parenthesized") {
                                  var $343 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                                  if ($343 instanceof Data_List_Types.Cons && $343.value1 instanceof Data_List_Types.Nil) {
                                      return new Parens($343.value0);
                                  };
                                  return v11(true);
                              };
                              return v11(true);
                          ...
                          if (v === "let") {
                              var $348 = Data_Array.drop(1)(children(n));
                              var $349 = Data_Array.findIndex(function (x) {
                                  return Data_Eq.eq(eqTypeString)(type_(x))("in");
                              })($348);
                              if ($349 instanceof Data_Maybe.Just) {
                                  var $350 = Data_Functor.map(Data_Functor.functorArray)(readNode)(Data_Array.take($349.value0)($348));
                                  var $351 = Data_Functor.map(Data_Functor.functorArray)(readNode)(Data_Array.drop($349.value0 + 1 | 0)($348));
                                  return new Let($350, $351);
                              };
                              return v9(true);
                          };
                          return v9(true);
                      ...
                      if (v === "if") {
                          var $355 = Data_List.fromFoldable(Data_Foldable.foldableArray)(namedChildren(n));
                          if ($355 instanceof Data_List_Types.Cons && ($355.value1 instanceof Data_List_Types.Cons && ($355.value1.value1 instanceof Data_List_Types.Cons && $355.value1.value1.value1 instanceof Data_List_Types.Nil))) {
                              return new If(readNode($355.value0), readNode($355.value1.value0), readNode($355.value1.value1.value0));
                          };
                          return v7(true);
                      };
                      return v7(true);
                  ...
                  if (v === "app") {
                      var $364 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                      if ($364 instanceof Data_List_Types.Cons && ($364.value1 instanceof Data_List_Types.Cons && $364.value1.value1 instanceof Data_List_Types.Nil)) {
                          return new App($364.value0, $364.value1.value0);
                      };
                      return v5(true);
                  };
                  return v5(true);
              ...
              if (v === "formal") {
                  var $371 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                  if ($371 instanceof Data_List_Types.Cons && $371.value1 instanceof Data_List_Types.Nil) {
                      return new Formal($371.value0, Data_Maybe.Nothing.value);
                  };
                  if ($371 instanceof Data_List_Types.Cons && ($371.value1 instanceof Data_List_Types.Cons && $371.value1.value1 instanceof Data_List_Types.Nil)) {
                      return new Formal($371.value0, new Data_Maybe.Just($371.value1.value0));
                  };
          ...
          if (v === "function") {
              var $381 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
              if ($381 instanceof Data_List_Types.Cons && ($381.value1 instanceof Data_List_Types.Cons && $381.value1.value1 instanceof Data_List_Types.Nil)) {
                  if ($381.value0 instanceof Formals) {
                      return new SetFunction($381.value0, $381.value1.value0);
                  };
                  return new $$Function($381.value0, $381.value1.value0);
              };
              return v1(true);
          };
          return v1(true);
