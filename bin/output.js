...
(function($PS) {
  ...
  var layout = function (v) {
      ...
      throw new Error("Failed pattern match at Motsunabe (line 42, column 1 - line 42, column 26): " + [ v.constructor.name ]);
  };
  var fits = function ($copy_w) {
      return function ($copy_v) {
          ...
          function $tco_loop(w, v) {
              ...
              throw new Error("Failed pattern match at Motsunabe (line 67, column 1 - line 67, column 32): " + [ w.constructor.name, v.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var be = function (w) {
      return function (k) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Motsunabe (line 55, column 1 - line 55, column 50): " + [ w.constructor.name, k.constructor.name, v.constructor.name ]);
          };
      };
  };
  var best = function (w) {
...
(function($PS) {
      ...
      return function (v) {
          ...
          var v1 = function (v2) {
              if (v instanceof AttrSet) {
                  var $228 = Data_Array["null"](v.value0);
                  if ($228) {
                      return new Motsunabe.DText("{}");
                  };
              ...
              if (v instanceof Let) {
                  ...
                  var expr$prime = (function () {
                      var v3 = function (v4) {
                          ...
                          throw new Error("Failed pattern match at FormatNix (line 231, column 1 - line 231, column 35): " + [  ]);
                      };
                      var $236 = Data_Array.length(v.value1) === 1;
                      if ($236) {
                          var $237 = Data_Array.head(v.value1);
                          if ($237 instanceof Data_Maybe.Just) {
                              return expr2Doc(ctx)($237.value0);
                          };
                          return v3(true);
                      };
                      return v3(true);
              ...
              if (v instanceof App) {
                  var newCtx = (function () {
                      var $250 = containsFetch(v.value0);
                      if ($250) {
                          return {
                              fetch: true
                          };
              ...
              throw new Error("Failed pattern match at FormatNix (line 231, column 1 - line 231, column 35): " + [ ctx.constructor.name, v.constructor.name ]);
          };
          if (v instanceof Attrs) {
              var $264 = Data_Functor.map(Data_Functor.functorArray)(expr2Doc(ctx))(v.value0);
              return new Motsunabe.DAlt(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Motsunabe.mDoc)(new Motsunabe.DText(" "))($264), new Motsunabe.DNest(1, dlines(Data_Foldable.foldableArray)($264)));
          };
          return v1(true);
      };
  };
  var printExpr = function ($406) {
      return Motsunabe.pretty(80)(expr2Doc(defaultContext)($406));
  };
  ...
  var namedChildren = function ($407) {
      return Data_Array.filter(isNamed)(children($407));
  };
      ...
      return function (n) {
          ...
          var v1 = function (v2) {
              ...
              var v3 = function (v4) {
                  ...
                  var v5 = function (v6) {
                      ...
                      var v7 = function (v8) {
                          ...
                          var v9 = function (v10) {
                              ...
                              var v11 = function (v12) {
                                  ...
                                  var v13 = function (v14) {
                                      ...
                                      var v15 = function (v16) {
                                          ...
                                          var v17 = function (v18) {
                                              ...
                                              var v19 = function (v20) {
                                                  ...
                                                  if (v === "binary") {
                                                      ...
                                                      if ($293 instanceof Data_List_Types.Cons && ($293.value1 instanceof Data_List_Types.Cons && ($293.value1.value1 instanceof Data_List_Types.Cons && $293.value1.value1.value1 instanceof Data_List_Types.Nil))) {
                                                          var $294 = readNode($293.value0);
                                                          if ($294 instanceof Data_Either.Right) {
                                                              var $295 = readNode($293.value1.value1.value0);
                                                              if ($295 instanceof Data_Either.Right) {
                                                                  return Data_Either.Right.create(new Binary($294.value0, text($293.value1.value0), $295.value0));
                                                              };
                                                              return v21(true);
                                                          };
                                                          return v21(true);
                                              ...
                                              if (v === "unary") {
                                                  var $306 = children(n);
                                                  var $307 = Data_List.fromFoldable(Data_Foldable.foldableArray)($306);
                                                  if ($307 instanceof Data_List_Types.Cons && ($307.value1 instanceof Data_List_Types.Cons && $307.value1.value1 instanceof Data_List_Types.Nil)) {
                                                      var $308 = readNode($307.value1.value0);
                                                      if ($308 instanceof Data_Either.Right) {
                                                          return Data_Either.Right.create(new Unary(text($307.value0), $308.value0));
                                                      };
                                                      return v19(true);
                                                  };
                                                  return v19(true);
                                          ...
                                          if (v === "select") {
                                              var $316 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                                              if ($316 instanceof Data_List_Types.Cons && ($316.value0 instanceof Data_Either.Right && ($316.value1 instanceof Data_List_Types.Cons && ($316.value1.value0 instanceof Data_Either.Right && $316.value1.value1 instanceof Data_List_Types.Nil)))) {
                                                  return Data_Either.Right.create(new Select($316.value0.value0, $316.value1.value0.value0));
                                              };
                                              return v17(true);
                                          };
                                          return v17(true);
                                      ...
                                      if (v === "with") {
                                          var $325 = namedChildren(n);
                                          var $326 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                                          if ($326 instanceof Data_List_Types.Cons && ($326.value0 instanceof Data_Either.Right && ($326.value1 instanceof Data_List_Types.Cons && ($326.value1.value0 instanceof Data_Either.Right && $326.value1.value1 instanceof Data_List_Types.Nil)))) {
                                              return Data_Either.Right.create(new With($326.value0.value0, $326.value1.value0.value0));
                                          };
                                          return v15(true);
                                      };
                                      return v15(true);
                                  ...
                                  if (v === "bind") {
                                      ...
                                      if ($336 instanceof Data_List_Types.Cons && ($336.value0 instanceof Data_Either.Right && ($336.value1 instanceof Data_List_Types.Cons && ($336.value1.value0 instanceof Data_Either.Right && $336.value1.value1 instanceof Data_List_Types.Nil)))) {
                                          return Data_Either.Right.create(new Bind($336.value0.value0, $336.value1.value0.value0));
                                      };
                                      return v13(true);
                                  };
                                  return v13(true);
                              ...
                              if (v === "parenthesized") {
                                  ...
                                  if ($345 instanceof Data_List_Types.Cons && ($345.value0 instanceof Data_Either.Right && $345.value1 instanceof Data_List_Types.Nil)) {
                                      return Data_Either.Right.create(new Parens($345.value0.value0));
                                  };
                                  return v11(true);
                              };
                              return v11(true);
                          ...
                          if (v === "let") {
                              var $351 = Data_Array.drop(1)(children(n));
                              var $352 = Data_Array.findIndex(function (x) {
                                  return Data_Eq.eq(eqTypeString)(type_(x))("in");
                              })($351);
                              if ($352 instanceof Data_Maybe.Just) {
                                  var $353 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(readNode)(Data_Array.take($352.value0)($351));
                                  if ($353 instanceof Data_Either.Right) {
                                      var $354 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(readNode)(Data_Array.drop($352.value0 + 1 | 0)($351));
                                      if ($354 instanceof Data_Either.Right) {
                                          return Data_Either.Right.create(new Let($353.value0, $354.value0));
                                      };
                                      return v9(true);
                                  };
                                  return v9(true);
                      ...
                      if (v === "if") {
                          var $360 = Data_List.fromFoldable(Data_Foldable.foldableArray)(namedChildren(n));
                          if ($360 instanceof Data_List_Types.Cons && ($360.value1 instanceof Data_List_Types.Cons && ($360.value1.value1 instanceof Data_List_Types.Cons && $360.value1.value1.value1 instanceof Data_List_Types.Nil))) {
                              var $361 = readNode($360.value0);
                              if ($361 instanceof Data_Either.Right) {
                                  var $362 = readNode($360.value1.value0);
                                  if ($362 instanceof Data_Either.Right) {
                                      var $363 = readNode($360.value1.value1.value0);
                                      if ($363 instanceof Data_Either.Right) {
                                          return Data_Either.Right.create(new If($361.value0, $362.value0, $363.value0));
                                      };
                                      return v7(true);
                                  };
                                  return v7(true);
                  ...
                  if (v === "app") {
                      var $375 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
                      if ($375 instanceof Data_List_Types.Cons && ($375.value0 instanceof Data_Either.Right && ($375.value1 instanceof Data_List_Types.Cons && ($375.value1.value0 instanceof Data_Either.Right && $375.value1.value1 instanceof Data_List_Types.Nil)))) {
                          return Data_Either.Right.create(new App($375.value0.value0, $375.value1.value0.value0));
                      };
                      return v5(true);
                  };
                  return v5(true);
              ...
              if (v === "formal") {
                  ...
                  if ($384 instanceof Data_List_Types.Cons && ($384.value0 instanceof Data_Either.Right && $384.value1 instanceof Data_List_Types.Nil)) {
                      return Data_Either.Right.create(new Formal($384.value0.value0, Data_Maybe.Nothing.value));
                  };
                  if ($384 instanceof Data_List_Types.Cons && ($384.value0 instanceof Data_Either.Right && ($384.value1 instanceof Data_List_Types.Cons && ($384.value1.value0 instanceof Data_Either.Right && $384.value1.value1 instanceof Data_List_Types.Nil)))) {
                      return Data_Either.Right.create(new Formal($384.value0.value0, new Data_Maybe.Just($384.value1.value0.value0)));
                  };
          ...
          if (v === "function") {
              var $397 = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(readNode)(namedChildren(n)));
              if ($397 instanceof Data_List_Types.Cons && ($397.value0 instanceof Data_Either.Right && ($397.value1 instanceof Data_List_Types.Cons && ($397.value1.value0 instanceof Data_Either.Right && $397.value1.value1 instanceof Data_List_Types.Nil)))) {
                  if ($397.value0.value0 instanceof Formals) {
                      return Data_Either.Right.create(new SetFunction($397.value0.value0, $397.value1.value0.value0));
                  };
                  return Data_Either.Right.create(new $$Function($397.value0.value0, $397.value1.value0.value0));
              };
              return v1(true);
          };
          return v1(true);
...
(function($PS) {
  ...
  var processExit = function ($8) {
      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)($foreign["_processExit"]($8));
  };
      ...
      if (v instanceof Data_Maybe.Just) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(v.value0))(function (v1) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)((function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 34, column 7 - line 43, column 7): " + [ nodes.constructor.name ]);
              })())(function () {
